...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!preg_match($pattern, $youtube_url)) {
        ...
        if (!$message) {
            $stmt = $pdo->prepare("
                INSERT INTO exercises (category_id, title, description, difficulty, duration_estimate, equipment_needed, youtube_url, thumbnail, is_published)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
            $stmt->execute([$category_id, $title, $description, $difficulty, $duration, $equipment, $youtube_url, $thumbnail, $is_published]);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="duration_estimate" class="form-control" placeholder="Misal: 10-15 menit">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Peralatan Dibutuhkan</label>
                                <input type="text" name="equipment_needed" class="form-control" placeholder="Misal: Dumbbell, Matras">
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-primary">Tambah Latihan</button>
